...
User-supplied screenshots, retained without image edits. These illustrate the UI; [the outputs overview](../../outputs/README.md) is the source of current results.

| File | What it shows | Capture context |
|---|---|---|
| [agent-inbox-all-reviews.png](agent-inbox-all-reviews.png) | Interrupted queue with four review requests | Earlier pending state; all six final mappings are now approved |
| [agent-inbox-review-details.png](agent-inbox-review-details.png) | ACNC mapping table, evidence, before/after example and review controls | Earlier ACNC v2 proposal, not the final approved ACNC v1 run |
